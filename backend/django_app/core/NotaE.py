...
class Generar_ReporteReembolsos(FPDF):
    def __init__(self, report_items, period_label, total_reembolsos, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.report_items = report_items
        self.period_label = period_label
        self.total_reembolsos = total_reembolsos
    ...
    def header(self):
        self.set_font('Arial', 'B', 16)
        self.cell(0, 10, 'REPORTE DE REEMBOLSOS', 0, 1, 'C')
        self.ln(2)
        self.set_font('Arial', '', 10)
        self.cell(0, 6, f'Período: {self.period_label}', 0, 1, 'L')
        self.ln(4)
    ...
    def generate_pdf(self):
        ...
        self.set_font('Arial', 'B', 11)
        self.cell(0, 8, 'Resumen de reembolsos', 0, 1, 'L')
        self.ln(2)
        self.set_font('Arial', '', 10)
        self.cell(0, 7, f'Total reembolsos: ${self.total_reembolsos:.2f}', 0, 1, 'L')
        self.ln(6)
        ...
        self.cell(60, 10, 'Cliente', 1, 0, 'L', 1)
        self.cell(30, 10, 'Monto', 1, 0, 'C', 1)
        self.cell(45, 10, 'Motivo rechazo', 1, 1, 'C', 1)
